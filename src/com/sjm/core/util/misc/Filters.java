...
public class Filters {
    ...
    public static final Filter<Character> IsVisible = ascii(Strings.PRINTABLE);
    public static final Filter<Character> IsSpecial = ascii(Strings.SPECIAL);
    public static final Filter<Character> IsBlank = ascii(Strings.BLANK);
    public static final Filter<Character> IsNamed = ascii(Strings.JAVA_NAMED_BODY);
