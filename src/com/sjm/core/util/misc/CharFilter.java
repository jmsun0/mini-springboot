...
public abstract class CharFilter implements Filter<Character> {
     ...
     * 
     */
    public static final CharFilter JavaNameHead = ascii(Strings.LETTER + "_$");

    public static final CharFilter JavaNameBody = ascii(Strings.LETTER_NUMBER + "_$");

    public static final CharFilter HexNumber = ascii(Strings.NUMBER + "abcdef" + "ABCDEF");
